...
defineUcTestSuite({
  ...
  "cases": [
    {
      "id": "TC-COMPANY-UC22-01",
      "kind": "functional",
      "title": "Cap nhat trang thai dang tuyen dung - luồng chính",
      "preconditions": [
      ...
      "steps": [
        "Mở /settings",
        "Thực hiện Cap nhat trang thai dang tuyen dung với dữ liệu: openToHire"
      ],
      "expected": [
    ...
    {
      "id": "TC-COMPANY-UC22-02",
      "kind": "required_fields",
      "title": "Cap nhat trang thai dang tuyen dung - trường bắt buộc",
      "preconditions": [
        "Actor Cong ty can reach /settings"
      ],
      "steps": [
        "Bỏ trống từng trường bắt buộc hoặc xác nhận bắt buộc rồi gửi form/thao tác. (openToHire)"
      ],
      "expected": [
        "Hệ thống chặn lưu.",
        "Báo lỗi đúng trường.",
    ...
    {
      "id": "TC-COMPANY-UC22-03",
      "kind": "boundary",
      "title": "Cap nhat trang thai dang tuyen dung - dữ liệu biên và sai định dạng",
      "preconditions": [
        "Actor Cong ty can reach /settings"
      ],
      "steps": [
        "Nhập dữ liệu min/max, quá giới hạn, sai định dạng hoặc file sai loại/dung lượng nếu UC có file. (openToHire)"
      ],
      "expected": [
    ...
    {
      "id": "TC-COMPANY-UC22-04",
      "kind": "auth",
      "title": "Cap nhat trang thai dang tuyen dung - truy cập và phiên đăng nhập",
      "preconditions": [
    ...
    {
      "id": "TC-COMPANY-UC22-05",
      "kind": "permission",
      "title": "Cap nhat trang thai dang tuyen dung - phân quyền và trạng thái nghiệp vụ",
      "preconditions": [
    ...
    {
      "id": "TC-COMPANY-UC22-06",
      "kind": "alternative",
      "title": "Cap nhat trang thai dang tuyen dung - ngoại lệ nghiệp vụ",
      "preconditions": [
        "Actor Cong ty can start Cap nhat trang thai dang tuyen dung"
      ],
      "steps": [
        "Thực hiện ngoại lệ nghiệp vụ cho Cap nhat trang thai dang tuyen dung"
      ],
      "expected": [
    ...
    {
      "id": "TC-COMPANY-UC22-07",
      "kind": "state_transition",
      "title": "Cap nhat trang thai dang tuyen dung - chuyển trạng thái",
      "preconditions": [
    ...
    {
      "id": "TC-COMPANY-UC22-08",
      "kind": "side_effect",
      "title": "Cap nhat trang thai dang tuyen dung - tác động liên quan",
      "preconditions": [
    ...
    {
      "id": "TC-COMPANY-UC22-09",
      "kind": "integration",
      "title": "Cap nhat trang thai dang tuyen dung - tích hợp dữ liệu",
      "preconditions": [
    ...
    {
      "id": "TC-COMPANY-UC22-10",
      "kind": "ui_feedback",
      "title": "Cap nhat trang thai dang tuyen dung - phản hồi giao diện",
      "preconditions": [
    ...
    {
      "id": "TC-COMPANY-UC22-11",
      "kind": "regression",
      "title": "Cap nhat trang thai dang tuyen dung - hồi quy sau sửa lỗi",
      "preconditions": [
