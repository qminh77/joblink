...
defineUcTestSuite({
  ...
  "cases": [
    {
      "id": "TC-SETTINGS-UC59-01",
      "kind": "functional",
      "title": "Xem tai khoan da chan va bo chan - luồng chính",
      "preconditions": [
      ...
      "steps": [
        "Mở /settings",
        "Thực hiện Xem tai khoan da chan va bo chan với dữ liệu: blockedUserId"
      ],
      "expected": [
    ...
    {
      "id": "TC-SETTINGS-UC59-02",
      "kind": "required_fields",
      "title": "Xem tai khoan da chan va bo chan - trường bắt buộc",
      "preconditions": [
        "Actor Nguoi dung can reach /settings"
      ],
      "steps": [
        "Bỏ trống từng trường bắt buộc hoặc xác nhận bắt buộc rồi gửi form/thao tác. (blockedUserId)"
      ],
      "expected": [
        "Hệ thống chặn lưu.",
        "Báo lỗi đúng trường.",
    ...
    {
      "id": "TC-SETTINGS-UC59-03",
      "kind": "boundary",
      "title": "Xem tai khoan da chan va bo chan - dữ liệu biên và sai định dạng",
      "preconditions": [
        "Actor Nguoi dung can reach /settings"
      ],
      "steps": [
        "Nhập dữ liệu min/max, quá giới hạn, sai định dạng hoặc file sai loại/dung lượng nếu UC có file. (blockedUserId)"
      ],
      "expected": [
    ...
    {
      "id": "TC-SETTINGS-UC59-04",
      "kind": "auth",
      "title": "Xem tai khoan da chan va bo chan - truy cập và phiên đăng nhập",
      "preconditions": [
    ...
    {
      "id": "TC-SETTINGS-UC59-05",
      "kind": "permission",
      "title": "Xem tai khoan da chan va bo chan - phân quyền và trạng thái nghiệp vụ",
      "preconditions": [
    ...
    {
      "id": "TC-SETTINGS-UC59-06",
      "kind": "alternative",
      "title": "Xem tai khoan da chan va bo chan - ngoại lệ nghiệp vụ",
      "preconditions": [
        "Actor Nguoi dung can start Xem tai khoan da chan va bo chan"
      ],
      "steps": [
        "Thực hiện ngoại lệ nghiệp vụ cho Xem tai khoan da chan va bo chan"
      ],
      "expected": [
    ...
    {
      "id": "TC-SETTINGS-UC59-07",
      "kind": "state_transition",
      "title": "Xem tai khoan da chan va bo chan - chuyển trạng thái",
      "preconditions": [
    ...
    {
      "id": "TC-SETTINGS-UC59-08",
      "kind": "side_effect",
      "title": "Xem tai khoan da chan va bo chan - tác động liên quan",
      "preconditions": [
    ...
    {
      "id": "TC-SETTINGS-UC59-09",
      "kind": "integration",
      "title": "Xem tai khoan da chan va bo chan - tích hợp dữ liệu",
      "preconditions": [
    ...
    {
      "id": "TC-SETTINGS-UC59-10",
      "kind": "ui_feedback",
      "title": "Xem tai khoan da chan va bo chan - phản hồi giao diện",
      "preconditions": [
    ...
    {
      "id": "TC-SETTINGS-UC59-11",
      "kind": "regression",
      "title": "Xem tai khoan da chan va bo chan - hồi quy sau sửa lỗi",
      "preconditions": [
