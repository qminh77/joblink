  ...
  "cases": [
    {
      "id": "TC-AUTH-UC02-01",
      "kind": "functional",
      "title": "Dang ky tai khoan cong ty - luồng chính",
      "preconditions": [
      ...
      "steps": [
        "Mở /register",
        "Thực hiện Dang ky tai khoan cong ty với dữ liệu: companyName, taxId, representativeName, email, password, termsAccepted"
      ],
      "expected": [
    ...
    },
    {
      ...
      "title": "Dang ky tai khoan cong ty - trường bắt buộc",
      "preconditions": [
        "Actor Khach can reach /register"
      ],
      "steps": [
        "Bỏ trống từng trường bắt buộc hoặc xác nhận bắt buộc rồi gửi form/thao tác. (companyName, taxId, representativeName, email, password, termsAccepted)"
      ],
      "expected": [
        "Hệ thống chặn lưu.",
        "Báo lỗi đúng trường.",
    ...
    },
    {
      "id": "TC-AUTH-UC02-03",
      "kind": "boundary",
      "title": "Dang ky tai khoan cong ty - dữ liệu biên và sai định dạng",
      "preconditions": [
        "Actor Khach can reach /register"
      ],
      "steps": [
        "Nhập dữ liệu min/max, quá giới hạn, sai định dạng hoặc file sai loại/dung lượng nếu UC có file. (companyName, taxId, representativeName, email, password, termsAccepted)"
      ],
      "expected": [
    ...
    },
    {
      "id": "TC-AUTH-UC02-04",
      "kind": "auth",
      "title": "Dang ky tai khoan cong ty - truy cập và phiên đăng nhập",
      "preconditions": [
    ...
    },
    {
      "id": "TC-AUTH-UC02-05",
      "kind": "permission",
      "title": "Dang ky tai khoan cong ty - phân quyền và trạng thái nghiệp vụ",
      "preconditions": [
    ...
    },
    {
      "id": "TC-AUTH-UC02-06",
      "kind": "alternative",
      "title": "Dang ky tai khoan cong ty - ngoại lệ nghiệp vụ",
      "preconditions": [
        "Actor Khach can start Dang ky tai khoan cong ty"
      ],
      "steps": [
        "Thực hiện ngoại lệ nghiệp vụ cho Dang ky tai khoan cong ty"
      ],
      "expected": [
    ...
    },
    {
      ...
      "title": "Dang ky tai khoan cong ty - chuyển trạng thái",
      "preconditions": [
    ...
    },
    {
      "id": "TC-AUTH-UC02-08",
      "kind": "side_effect",
      "title": "Dang ky tai khoan cong ty - tác động liên quan",
      "preconditions": [
    ...
    },
    {
      "id": "TC-AUTH-UC02-09",
      "kind": "integration",
      "title": "Dang ky tai khoan cong ty - tích hợp dữ liệu",
      "preconditions": [
    ...
    },
    {
      "id": "TC-AUTH-UC02-10",
      "kind": "ui_feedback",
      "title": "Dang ky tai khoan cong ty - phản hồi giao diện",
      "preconditions": [
    ...
    },
    {
      "id": "TC-AUTH-UC02-11",
      "kind": "regression",
      "title": "Dang ky tai khoan cong ty - hồi quy sau sửa lỗi",
      "preconditions": [
