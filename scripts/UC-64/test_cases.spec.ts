  ...
  "cases": [
    {
      "id": "TC-ADMIN-UC64-01",
      "kind": "functional",
      "title": "Kiem duyet bai viet - luồng chính",
      "preconditions": [
        "Actor Quan tri vien matches the SRS actor for UC-64",
        "Route /admin/posts is reachable"
      ],
      "steps": [
        "Mở /admin/posts",
        "Thực hiện Kiem duyet bai viet với dữ liệu: postId, action"
      ],
      "expected": [
    ...
    },
    {
      ...
      "title": "Kiem duyet bai viet - trường bắt buộc",
      "preconditions": [
        "Actor Quan tri vien can reach /admin/posts"
      ],
      "steps": [
        "Bỏ trống từng trường bắt buộc hoặc xác nhận bắt buộc rồi gửi form/thao tác. (postId, action)"
      ],
      "expected": [
        "Hệ thống chặn lưu.",
        "Báo lỗi đúng trường.",
    ...
    },
    {
      "id": "TC-ADMIN-UC64-03",
      "kind": "boundary",
      "title": "Kiem duyet bai viet - dữ liệu biên và sai định dạng",
      "preconditions": [
        "Actor Quan tri vien can reach /admin/posts"
      ],
      "steps": [
        "Nhập dữ liệu min/max, quá giới hạn, sai định dạng hoặc file sai loại/dung lượng nếu UC có file. (postId, action)"
      ],
      "expected": [
    ...
    },
    {
      "id": "TC-ADMIN-UC64-04",
      "kind": "auth",
      "title": "Kiem duyet bai viet - truy cập và phiên đăng nhập",
      "preconditions": [
    ...
    },
    {
      "id": "TC-ADMIN-UC64-05",
      "kind": "permission",
      "title": "Kiem duyet bai viet - phân quyền và trạng thái nghiệp vụ",
      "preconditions": [
    ...
    },
    {
      "id": "TC-ADMIN-UC64-06",
      "kind": "alternative",
      "title": "Kiem duyet bai viet - ngoại lệ nghiệp vụ",
      "preconditions": [
        "Actor Quan tri vien can start Kiem duyet bai viet"
      ],
      "steps": [
        "Thực hiện ngoại lệ nghiệp vụ cho Kiem duyet bai viet"
      ],
      "expected": [
    ...
    },
    {
      ...
      "title": "Kiem duyet bai viet - chuyển trạng thái",
      "preconditions": [
    ...
    },
    {
      "id": "TC-ADMIN-UC64-08",
      "kind": "side_effect",
      "title": "Kiem duyet bai viet - tác động liên quan",
      "preconditions": [
    ...
    },
    {
      "id": "TC-ADMIN-UC64-09",
      "kind": "integration",
      "title": "Kiem duyet bai viet - tích hợp dữ liệu",
      "preconditions": [
    ...
    },
    {
      "id": "TC-ADMIN-UC64-10",
      "kind": "ui_feedback",
      "title": "Kiem duyet bai viet - phản hồi giao diện",
      "preconditions": [
    ...
    },
    {
      "id": "TC-ADMIN-UC64-11",
      "kind": "regression",
      "title": "Kiem duyet bai viet - hồi quy sau sửa lỗi",
      "preconditions": [
