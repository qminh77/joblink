-- Kế thừa từ schema.sql, tạo migration cập nhật get_home_feed bỏ tính năng xóa ghi vô ích
...
BEGIN
    ...
    RETURN jsonb_build_object(
        'stats', v_stats, 'suggestions', v_suggestions, 'suggested_jobs', v_suggested_jobs,
        'posts', v_posts, 'jobs', v_jobs, 'connection_ids', v_connection_ids,
        'me', jsonb_build_object('userId', v_me), 'next_cursor', v_next_cursor
    );
END;
$$;
